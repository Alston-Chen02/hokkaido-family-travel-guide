const itinerary = [
  ...
  {day:2,date:'9/20',title:'大沼公園・海洋公園 → 札幌',sub:'湖光山色、企鵝遊行與童話甜點世界',stops:['大・小沼國定公園','尼克斯海洋公園','白色戀人公園（不入館）','札幌'],meals:'早｜飯店早餐\n午｜壽喜燒鍋物\n晚｜敬請自理',hotel:'札幌 T-MARK、RESOL、PREMIER 中島公園、IBIS、Quintessa 或同級',memo:'這天車程較長，可帶頸枕與薄外套。海洋公園若休園將依原行程安排替代景點。'},
...
const dayGuides={
  ...
  ],links:[['函館山官方交通與壅塞資訊','https://www.hakodate.travel/cht/information/mt-hakodate/']]},
  ...
  ],links:[['大沼公園官方指南','https://www.visit-hokkaido.jp/tw/spot/detail_10299.html'],['尼克斯官方表演資訊','https://nixe-aqua.com/zh/'],['白色戀人公園官方資訊','https://www.shiroikoibitopark.jp/zh-hant/']]},
  3:{intro:'白天小樽慢走、晚上狸小路自由活動；先約好集合點與時間。',items:[
    ...
    ['午餐自理','本日餐食卡已整理壽司、洋食與家常定食三種選擇；先確認領隊安排的自由活動範圍和集合時間，再決定要往哪一間走。'],
  ...
  ],links:[['支笏湖官方指南','https://www.visit-hokkaido.jp/tw/spot/detail_10145.html'],['洞爺湖花火官方資訊','https://www.laketoya.com/tw/event/fireworks/']]},
...
const mealRecommendations={
  2:{title:'札幌晚餐自理',intro:'長途車程後以方便回飯店為優先。以下都在薄野一帶；實際飯店可能不同，先向領隊確認下車點、自由時間與返程方式。',choices:[
    {name:'松尾成吉思汗烤肉｜薄野 4・2 店',tag:'北海道烤羊肉',place:'薄野站附近',hours:'16:30 開始，末點餐 22:00；閉店時間請查當日公告',tip:'想吃北海道特色可選這間；用餐需烤肉，若時間有限先訂位。',rating:'4.2',reviewCount:'413',reviewNote:'近期有羊肉料理好評；熱門時段仍建議先確認候位。',mapsQuery:'松尾ジンギスカン すすきの4・2店',url:'https://www.matsuo1956.jp/foreign-landing/zh-tw/',lang:'繁中'},
    {name:'根室花丸迴轉壽司｜COCONO SUSUKINO',tag:'壽司・海鮮',place:'COCONO SUSUKINO B1F',hours:'11:00–21:00（末點餐 20:30）',tip:'現場領號候位、不接受訂位；排隊過長時改選其他店。',rating:'4.0',reviewCount:'768',reviewNote:'近期評論顯示候位長短差很多；到場先取號。',mapsQuery:'回転寿司 根室花まる ココノススキノ店',url:'https://www.sushi-hanamaru.com/store/details/cocono.html',lang:'日文'},
    {name:'札幌味噌拉麵 すみれ｜薄野店',tag:'味噌拉麵',place:'南 3 條西 3 丁目・2F',hours:'營業時間與末點餐請查 Google 地圖當日資訊',tip:'經典濃厚味噌；若不愛鹹或晚餐時間短，建議選其他店。',rating:'3.9',reviewCount:'3,631',reviewNote:'近期有人讚湯頭濃郁，也有人反映偏鹹、需排隊約 30–40 分鐘。',mapsQuery:'すみれ すすきの店 ラーメン',url:'https://www.google.com/maps/search/?api=1&query=%E3%81%99%E3%81%BF%E3%82%8C%20%E3%81%99%E3%81%99%E3%81%8D%E3%81%AE%E5%BA%97%20%E3%83%A9%E3%83%BC%E3%83%A1%E3%83%B3&hl=zh-TW',lang:'Google 地圖繁中'}
  ]},
  3:{title:'小樽午餐自理',intro:'三間都在堺町散策路線一帶；先確認領隊放行位置，別為吃飯走出集合範圍。',choices:[
    {name:'小樽竹野壽司',tag:'壽司・海鮮丼',place:'堺町 2-22・運河步行約 5 分鐘',hours:'午餐 11:00–16:00；食材售完可能提早關門',tip:'可吃握壽司，也有熟食與烤物；不吃生食可先看菜單。',rating:'4.3',reviewCount:'592',reviewNote:'近期評論對壽司、烤魚與價格評價不錯；假日仍應預留候位時間。',mapsQuery:'小樽たけの寿司 堺町2-22',url:'https://otaru.gr.jp/shop/takenosushi',lang:'日文・小樽觀光協會'},
    {name:'LeTAO Pathos',tag:'蛋包飯・義大利麵',place:'堺町 5-22',hours:'咖啡餐廳 10:00–18:00（末點餐 17:30）',tip:'不吃生食的備選；可用正餐搭甜點，假日可能排隊。',rating:'4.2',reviewCount:'2,776',reviewNote:'近期評論提到餐點好吃，也有人等候約 30 分鐘。',mapsQuery:'LeTAO Pathos 小樽',url:'https://www.letao-brand.jp/zh-tw/shop/pathos/',lang:'繁中'},
    {name:'小樽万次郎',tag:'家常定食・熟食',place:'堺町 2-15・運河步行約 5 分鐘',hours:'約 11:00–15:00；不定休、飯售完可能提早結束',tip:'可選烤魚、炸蝦或丼飯；店面小，宜早去並備現金。',rating:'4.2',reviewCount:'565',reviewNote:'近期多稱讚定食實惠、烤魚與蝦飯；座位少且熱門餐點可能售完。',mapsQuery:'万次郎 小樽 堺町2-15',url:'https://www.google.com/maps/search/?api=1&query=%E4%B8%87%E6%AC%A1%E9%83%8E%20%E5%B0%8F%E6%A8%BD%20%E5%A0%BA%E7%94%BA2-15&hl=zh-TW',lang:'Google 地圖繁中'}
  ]},
  4:{title:'北廣島 OUTLET 午餐自理',intro:'三間都在 Clover Mall 2F，以購物途中就近用餐與不同口味為主；Google 評分多落在 3 分多，請按方便性與口味選。',choices:[
    {name:'豚丼のぶたはげ',tag:'帶廣風豬肉丼',place:'Clover Mall 2F',hours:'10:30–21:00（末點餐 20:30）',tip:'想吃北海道特色豬肉丼可選。',rating:'3.9',reviewCount:'305',reviewNote:'近期有餐點好評，也提到價格上漲；點餐前先看菜單。',mapsQuery:'豚丼のぶたはげ 札幌北広島店',url:'https://mitsui-shopping-park.com/tw/mop/sapporo/shop/800086.html',lang:'繁中'},
    {name:'ごまそば処 八雲',tag:'芝麻蕎麥麵',place:'Clover Mall 2F',hours:'10:30–21:00（末點餐 20:30）',tip:'偏好清爽麵食可選；如對蕎麥過敏請避開。',rating:'3.6',reviewCount:'169',reviewNote:'近期評論喜歡麵條口感，但配菜評價較普通。',mapsQuery:'ごまそば八雲 北広島店',url:'https://mitsui-shopping-park.com/tw/mop/sapporo/shop/800085.html',lang:'繁中'},
    {name:'弟子屈拉麵',tag:'北海道拉麵',place:'Clover Mall 2F',hours:'10:30–21:00（末點餐 20:30）',tip:'想吃熱湯麵可選；不愛重口味可先看其他店。',rating:'3.7',reviewCount:'645',reviewNote:'近期有人喜歡魚介醬油湯頭，也有人覺得偏鹹。',mapsQuery:'弟子屈ラーメン 札幌北広島店',url:'https://mitsui-shopping-park.com/tw/mop/sapporo/shop/800090.html',lang:'繁中'}
  ]},
  5:{title:'函館午餐自理',intro:'本團另贈幸運小丑漢堡；其他店均須自行付費。返程日時間緊，先問領隊是否有自由用餐時間與範圍，再決定是否改吃其他店。',choices:[
    {name:'幸運小丑漢堡',tag:'團體贈送優先',place:'取餐分店與方式依領隊通知',hours:'依領隊取餐安排',tip:'若時間有限，直接吃團體贈送的漢堡最省心；贈送品項以領隊說明為準。',reviewNote:'分店尚未確定，不能把某一家分店的 Google 評分當作團體取餐店的分數。',url:'https://luckypierrot.jp/en/menu/',lang:'英文'},
    {name:'函館啤酒館',tag:'金森倉庫內用餐',place:'金森紅磚倉庫・函館歷史廣場',hours:'9/23 國定假日 11:00 開始',tip:'若在金森倉庫有足夠自由時間，可坐下用餐；請先估算出餐與回集合點所需時間。',rating:'4.0',reviewCount:'2,856',reviewNote:'近期有環境、料理與啤酒好評；坐下用餐需預留出餐時間。',mapsQuery:'函館ビヤホール 金森',url:'https://hakodate-kanemori.com/tw',lang:'繁中場館'},
    {name:'五島軒函館咖哩 EXPRESS',tag:'函館咖哩',place:'五稜郭塔 2F',hours:'11:00–15:30（末點餐 15:00）',tip:'若領隊在五稜郭塔放行午餐，可就地用餐；若無自由時間就不要離隊。',rating:'3.9',reviewCount:'310',reviewNote:'近期有人稱讚咖哩，也有人反映服務普通；若時間緊就別排隊。',mapsQuery:'五島軒 函館カレーエクスプレス 五稜郭タワー店',url:'https://gotoken1879.jp/goryokaku/',lang:'日文'}
  ]}
};
const renderMeals=d=>{const meal=mealRecommendations[d.day];if(!meal)return '';return `<details class="meal-guide" open><summary><span>🍽️ ${meal.title}</span><small>推薦餐廳</small></summary><div class="meal-guide-body"><p class="meal-intro">${meal.intro}</p><div class="meal-options">${meal.choices.map((choice,i)=>`<article class="meal-option"><span class="meal-number">0${i+1}</span><div><span class="meal-tag">${choice.tag}</span><h4>${choice.name}</h4>${choice.rating?`<p class="meal-rating" aria-label="Google 地圖評分 ${choice.rating} 分，${choice.reviewCount} 則評論"><span aria-hidden="true">★</span> <strong>${choice.rating}/5</strong> <small>Google 地圖 · ${choice.reviewCount} 則</small></p>`:'<p class="meal-rating meal-rating-pending">Google 分店評分：待領隊確認</p>'}<p><strong>位置：</strong>${choice.place}</p><p><strong>營業：</strong>${choice.hours}</p><p class="meal-review-note"><strong>${choice.rating?'近期評論':'評分說明'}：</strong>${choice.reviewNote}</p><p>${choice.tip}</p><div class="meal-links"><a href="${choice.url}" target="_blank" rel="noopener noreferrer">${choice.url.includes('google.com/maps/')?'查看地點':'查看店舖資訊'}（${choice.lang}）↗</a>${choice.mapsQuery&&!choice.url.includes('google.com/maps/')?`<a href="https://www.google.com/maps/search/?api=1&amp;query=${encodeURIComponent(choice.mapsQuery)}&amp;hl=zh-TW" target="_blank" rel="noopener noreferrer">Google 最新評論 ↗</a>`:''}</div></div></article>`).join('')}</div><p class="meal-caveat">Google 地圖分數與評論數為 2026/9/17 查核快照，非即時更新；近期評論為個別體驗摘要，不代表保證。9/21、9/23 為日本國定假日，營業時間可能不同。請依當日店舖公告與領隊集合時間為準。</p></div></details>`};
const drugstoreGuides={
  2:{intro:'札幌晚餐自理後，只有在領隊確認可自由活動、且飯店或下車處靠近薄野時才前往。',shops:[
    {zone:'薄野晚餐後',name:'札幌藥妝・薄野店',place:'南 4 條西 3 丁目，第 2 G 大樓 1F',hours:'13:00–00:00',tip:'薄野餐廳區內，適合吃完晚餐後順路補貨；先確認回飯店動線。',maps:'サツドラすすきの店 南4条西3丁目 第2Gビル',official:'https://shop.satudora.co.jp/detail/store-susukino/'},
    {zone:'薄野・狸小路 5 丁目一帶',name:'大國藥妝・MEGA 狸小路店',place:'南 3 條西 5 丁目 28（官方門牌）',hours:'10:05–22:50',tip:'晚餐後若可走到狸小路 5 丁目，可選這間免稅店。Google 地圖門牌顯示 27，定位已核對官方地圖；請認 MEGA 店招，與「狸小路 5 丁目店」不同。',maps:'ダイコクドラッグメガ狸小路店',mapsPlaceId:'ChIJP6CoMAApC18Rc8vnb0lroaY',official:'https://daikokudrug.com/store/704/',lang:'日文'}
  ]},
  3:{intro:'小樽未查到大國藥妝分店，可先逛堺町的札幌藥妝；想買大國藥妝可留到晚上狸小路 5 丁目。依集合點選一間即可，不必每間都逛。',shops:[
    {zone:'小樽・堺町散策',name:'札幌藥妝・小樽堺町店',place:'堺町 2-17',hours:'10:30–19:00',tip:'與堺町午餐、散策路線同街；先吃飯或先購物，依集合時間決定。',maps:'サツドラ小樽堺町店 北海道小樽市堺町2-17',official:'https://shop.satudora.co.jp/detail/store-otarusakaemachi/'},
    {zone:'狸小路東側・3 丁目',name:'札幌藥妝・moyuk SAPPORO',place:'南 2 條西 3 丁目 20，moyuk SAPPORO 1F',hours:'10:00–22:00',tip:'若從狸小路 3 丁目附近開始逛，可先到這間；22:00 前完成結帳。',maps:'サツドラmoyuk SAPPORO 南2条西3丁目20',official:'https://shop.satudora.co.jp/detail/store-moyuk_SAPPORO/'},
    {zone:'狸小路西側・5 丁目',name:'札幌藥妝・狸小路大王大樓店',place:'南 2 條西 5 丁目 23-1',hours:'10:00–23:00',tip:'若集合點靠近 5 丁目，可選這間，無須走回 3 丁目。',maps:'サツドラ狸小路大王ビル店 南2条西5丁目23-1',official:'https://shop.satudora.co.jp/detail/store-tanukikojidaio/'},
    {zone:'狸小路西側・5 丁目',name:'大國藥妝・狸小路 5 丁目店',place:'南 2 條西 5 丁目 15-2',hours:'10:05–22:50',tip:'就在狸小路 5 丁目散策區，提供免稅服務；適合在本晚自由購物時順路挑選，結帳及退稅請預留時間。',maps:'ダイコクドラッグ 狸小路5丁目店 南二条西5丁目15-2',mapsPlaceId:'ChIJY5cna2gpC18R3ORUJJOfYz8',official:'https://daikokudrug.com/store/603/',lang:'日文'},
    {zone:'狸小路西側・5 丁目備選',name:'大國藥妝・MEGA 狸小路店',place:'南 3 條西 5 丁目 28（官方門牌）',hours:'10:05–22:50',tip:'與「狸小路 5 丁目店」是不同分店，可就近擇一；第 2 天若已買齊就不用再逛。Google 地圖門牌顯示 27，定位已核對官方地圖，請認 MEGA 店招。',maps:'ダイコクドラッグメガ狸小路店',mapsPlaceId:'ChIJP6CoMAApC18Rc8vnb0lroaY',official:'https://daikokudrug.com/store/704/',lang:'日文'}
  ]},
  4:{intro:'截至 2026/9/18，大國藥妝官方北海道名單未列北廣島、支笏湖或洞爺湖分店。OUTLET 可選館內松本清；想買大國藥妝，建議第 2～3 天在札幌完成。',shops:[
    {zone:'北廣島三井 OUTLET',name:'松本清 OUTLET',place:'Clover Mall 2F',hours:'依館內當日公告',tip:'先拍館內樓層圖及集合點；若要退稅，結帳前準備護照。',maps:'マツモトキヨシ OUTLET 三井アウトレットパーク 札幌北広島店',official:'https://mitsui-shopping-park.com/tw/mop/sapporo/shop/800055.html',lang:'繁中'}
  ]},
  5:{intro:'金森倉庫周邊可選札幌藥妝或明治館的大國藥妝。返程日時間緊，僅在領隊明確放行且不影響機場報到時前往，不必另跑函館站前分店。',shops:[
    {zone:'函館・金森紅磚倉庫',name:'札幌藥妝・函館金森倉庫店',place:'豐川町 11-6',hours:'09:30–19:00',tip:'在金森倉庫散策區，先確認集合倉庫與機場出發時間；不建議為購物離開團體動線。',maps:'サツドラ函館金森倉庫店 函館市豊川町11-6',official:'https://shop.satudora.co.jp/detail/store-hakodatekanemorisoko/'},
    {zone:'金森倉庫周邊・函館明治館',name:'大國藥妝・函館明治館店',place:'豐川町 11-17，函館明治館',hours:'10:05–20:40',tip:'與金森倉庫同屬港灣散策區，提供免稅服務。先確認集合點，僅補買清單上的物品，預留結帳與回集合處的時間。',maps:'ダイコクドラッグ 函館明治館店 豊川町11-17',official:'https://daikokudrug.com/store/677/',lang:'日文'}
  ]}
};
const renderDrugstores=d=>{
  const guide=drugstoreGuides[d.day];
  if(!guide)return '';
  return `<details class="drugstore-guide"><summary><span>💊 自由時間・附近藥妝</span><small>${guide.shops.length} 間可選</small></summary><div class="drugstore-body"><p class="drugstore-intro">${guide.intro}</p><div class="drugstore-list">${guide.shops.map(shop=>`<article class="drugstore-card"><span class="drugstore-zone">${shop.zone}</span><h4>${shop.name}</h4><p><strong>位置：</strong>${shop.place}</p><p><strong>通常營業：</strong>${shop.hours}</p><p>${shop.tip}</p><div class="drugstore-links"><a href="https://www.google.com/maps/search/?api=1&amp;query=${encodeURIComponent(shop.maps)}${shop.mapsPlaceId?`&amp;query_place_id=${encodeURIComponent(shop.mapsPlaceId)}`:''}&amp;hl=zh-TW" target="_blank" rel="noopener noreferrer">Google 地圖（繁中）↗</a><a href="${shop.official}" target="_blank" rel="noopener noreferrer">官方店舖資訊${shop.lang?`（${shop.lang}）`:''} ↗</a></div></article>`).join('')}</div><p class="drugstore-caveat">Google 地圖與官方頁面已核對分店位置；大國藥妝資訊核對日期：2026/9/18。營業時間、庫存及免稅條件可能調整，出發前或到店當日再查看。先拍集合點、設定回程提醒；購買藥品請向藥師確認適用性。</p></div></details>`;
};
const outletGuide=`<details class="outlet-guide" open><summary>北廣島 OUTLET 購物指南</summary><div class="outlet-guide-grid"><section><h4>先買什麼</h4><ul><li><strong>北海道伴手禮：</strong>北海道四季彩館，集中挑選甜點、酒類與地方名產。</li><li><strong>服飾戶外：</strong>先看當日折扣，再比台灣售價；試穿後確認退換貨規定。</li><li><strong>省時動線：</strong>先拍集合地點，設定鬧鐘；大型物品最後再買。</li></ul></section><section class="drugstore-tip"><h4>館內藥妝 ✓</h4><p>松本清 OUTLET 位於 Clover Mall 2F；店舖定位及地圖請看上方「自由時間・附近藥妝」。</p></section></div><div class="outlet-links"><a href="https://mitsui-shopping-park.com/mop/sapporo/tw/" target="_blank" rel="noopener">OUTLET 官方指南 ↗</a><a href="https://mitsui-shopping-park.com/tw/mop/sapporo/shop/800055.html" target="_blank" rel="noopener">松本清店舖資訊（繁中）↗</a></div><p class="guide-note">商店、餐廳與優惠可能調整，請以到訪當日館內及官方公告為準。</p></details>`;
...
if('serviceWorker' in navigator){
  ...
  navigator.serviceWorker.addEventListener('controllerchange',()=>{if(refreshing)return;refreshing=true;if(!sessionStorage.getItem('pwa-v20-reloaded')){sessionStorage.setItem('pwa-v20-reloaded','1');location.reload()}});

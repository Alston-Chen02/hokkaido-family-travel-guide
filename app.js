...
if('serviceWorker' in navigator){
  ...
  navigator.serviceWorker.addEventListener('controllerchange',()=>{if(refreshing)return;refreshing=true;if(!sessionStorage.getItem('pwa-v18-reloaded')){sessionStorage.setItem('pwa-v18-reloaded','1');location.reload()}});
